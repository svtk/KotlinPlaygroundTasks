package quizzes._2week.taxipark

/* HEAD */
// Taxi Park. Pareto Principle
...
// It should return true if the top 20% drivers (meaning the top 20% best
...
fun TaxiPark.checkParetoPrinciple(): Boolean {
    ...
    val totalIncome = trips.sumByDouble(/*[mark]*/TODO()/*[mark]*/)
    val sortedDriversIncome: List<Double> = trips
            .groupBy(/*[mark]*/TODO()/*[mark]*/)
            .map { (_, tripsByDriver) -> tripsByDriver.sumByDouble(/*[mark]*/TODO()/*[mark]*/) }
            .sortedDescending()
